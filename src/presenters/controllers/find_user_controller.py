...
from src.doman.use_cases.find_user import FindUser
...
class FindUserController:
    ...
    def __init__(self, find_user_use_case: Type[FindUser]):
        self.find_use_use_case = find_user_use_case
    ...
    def handle(self, http_request: type[HttpRequest]) -> HttpResponse:
        ...
        if http_request.query:
            ...
            if "user_id" in query_string_params and "user_name" in query_string_params:
                ...
                response = self.find_use_use_case.by_id_and_by_name(
                ...
                user_id = http_request.query["user_id"]
                response = self.find_use_use_case.by_id(user_id=user_id)
                ...
                user_name = http_request.query["user_name"]
                response = self.find_use_use_case.by_name(user_name=user_name)
